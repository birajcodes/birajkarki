// lucide-react 1.x dropped brand glyphs (GitHub/LinkedIn) — these are the
// standard, widely-used mark paths, kept minimal and styled to match the
// surrounding lucide icon set (currentColor, viewBox 0 0 24 24).
...
export function LinkedinMark({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MediumMark({ size = 16, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
